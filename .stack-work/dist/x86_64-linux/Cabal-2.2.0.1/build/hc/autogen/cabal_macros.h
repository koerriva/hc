...
/* package hc-0.1.0.0 */
#ifndef VERSION_hc
#define VERSION_hc "0.1.0.0"
#endif /* VERSION_hc */
#ifndef MIN_VERSION_hc
#define MIN_VERSION_hc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hc */
...
/* package llvm-hs-pure-6.2.1 */
#ifndef VERSION_llvm_hs_pure
#define VERSION_llvm_hs_pure "6.2.1"
...
/* package llvm-hs-6.3.0 */
#ifndef VERSION_llvm_hs
#define VERSION_llvm_hs "6.3.0"
...
#define CURRENT_COMPONENT_ID "hc-0.1.0.0-L77RBSAd0MfKBUGwNI9ENO-hc"
